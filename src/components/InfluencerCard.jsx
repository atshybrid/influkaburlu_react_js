        ...
        <div className="rounded-3xl bg-white overflow-hidden">
          ...
          <div className="px-4 py-3">
            ...
            <div className="mt-2 flex items-center justify-between">
              <Link to={`/influencer/${slug}`} className="px-3 py-1.5 rounded-md text-xs font-medium text-gray-700 ring-1 ring-gray-200 hover:bg-gray-50">Open</Link>
              <div className="flex items-center gap-2">
      ...
      <div className="group rounded-3xl p-[2px] bg-gradient-to-br from-gray-900 via-gray-700 to-black transition-transform duration-300 hover:-translate-y-1 hover:shadow-2xl">
        <div className="rounded-3xl bg-black overflow-hidden text-white">
          ...
          <div className="px-4 py-3">
            <div className="text-sm font-semibold">{followers} followers</div>
            <div className="mt-2 flex items-center justify-between">
              <Link to={`/influencer/${slug}`} className="px-3 py-1.5 rounded-md text-xs font-medium bg-white text-black ring-1 ring-white/20 hover:bg-white/90">Open</Link>
              <div className="flex items-center gap-2">
                {platforms.includes('instagram') && <IconInstagram/>}
                {platforms.includes('youtube') && <IconYouTube/>}
                {platforms.includes('tiktok') && <IconTikTok/>}
      ...
      <div className="rounded-3xl bg-white overflow-hidden">
        ...
        <div className="p-5">
          <div className="flex items-start justify-between gap-3">
            ...
            <Link to={`/influencer/${slug}`} className="shrink-0 px-2.5 py-1.5 rounded-md text-xs font-medium text-white bg-gradient-to-r from-orange-600 to-pink-600 hover:from-orange-500 hover:to-pink-500">View</Link>
          </div>
